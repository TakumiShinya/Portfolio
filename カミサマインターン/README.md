...
初期状態の島には、「ニンゲン」・「ドウブツ」・「木」が存在しています。

ニンゲンとドウブツを食べることで体力を回復し、一定以上の体力がある状態で木にぶつかると、木を家に変えます。

反対に、ニンゲンがドウブツを食べられなかった場合、体力が時間経過で減っていき、0になると

ゲームはシミュレーションパートとカード選択パートの2つのパートがあり、これらを繰り返すことでゲームが進んでいきます。
